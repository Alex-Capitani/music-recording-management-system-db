...
/* =======================================================
   ...
   Schema Installation Script (MySQL/MariaDB)
   ======================================================= */
...
CREATE TABLE musica (
    cod_musica INT NOT NULL AUTO_INCREMENT,
    cod_categoria INT NOT NULL,
    duracao INT,
    titulo VARCHAR(100),
    PRIMARY KEY (cod_musica),
    CONSTRAINT musica_cod_categoria_fkey
...
CREATE TABLE fone (
    ...
    CONSTRAINT fone_cod_pessoa_fkey
      FOREIGN KEY (cod_pessoa) REFERENCES pessoa(cod_pessoa)
);

/* =======================================================
   Seed Data (Sample Inserts)
   ======================================================= */
